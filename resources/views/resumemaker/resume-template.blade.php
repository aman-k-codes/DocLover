            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 border-t pt-5" id="templateContainer">
                ...
                <div class="template-item relative group border rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition duration-300"
                    ...
                    <div
                        ...
                        <button
                            onclick="gotoFillData(base64encoded('.{{asset('public/assets/temp-imgs/pitcher/ptr (1).jpg')}}.'));"
                ...
                <div class="template-item relative group border rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition duration-300"
                    ...
                    <div
                        class="absolute inset-0 flex items-center justify-center bg-black bg-opacity-50 opacity-0 group-hover:opacity-100 transition duration-300">
                        <button
                            onclick="gotoFillData(base64encoded('.{{asset('public/assets/temp-imgs/two-column/tclm (1).jpg')}}.'));"
                            class="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition">Use
                            Template</button>
                    </div>
                </div>
                <div class="template-item relative group border rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition duration-300"
                    ...
                    <div
                        class="absolute inset-0 flex items-center justify-center bg-black bg-opacity-50 opacity-0 group-hover:opacity-100 transition duration-300">
                        <button
                            onclick="gotoFillData(base64encoded('.{{asset('public/assets/temp-imgs/google-docs/gd (1).jpg')}}.'));"
                            class="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition">Use
                            Template</button>
                    </div>
                </div>
                ...
                <div class="template-item relative group border rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition duration-300"
                    ...
                    <div
                        class="absolute inset-0 flex items-center justify-center bg-black bg-opacity-50 opacity-0 group-hover:opacity-100 transition duration-300">
                        <button
                            onclick="gotoFillData(base64encoded('.{{asset('public/assets/temp-imgs/two-column/tclm (2).jpg')}}.'));"
                            class="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition">Use
                            Template</button>
                    </div>
                </div>
                <div class="template-item relative group border rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition duration-300"
                    ...
                    <div
                        class="absolute inset-0 flex items-center justify-center bg-black bg-opacity-50 opacity-0 group-hover:opacity-100 transition duration-300">
                        <button
                            onclick="gotoFillData(base64encoded('.{{asset('public/assets/temp-imgs/google-docs/gd (1).png')}}.'));"
                            class="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition">Use
                            Template</button>
                    </div>
                </div>
                <div class="template-item relative group border rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition duration-300"
                    ...
                    <div
                        class="absolute inset-0 flex items-center justify-center bg-black bg-opacity-50 opacity-0 group-hover:opacity-100 transition duration-300">
                        <button
                            onclick="gotoFillData(base64encoded('.{{asset('public/assets/temp-imgs/two-column/tclm (2).png')}}.'));"
                            class="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition">Use
                            Template</button>
                    </div>
                </div>
                ...
                <div class="template-item relative group border rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition duration-300"
                    ...
                    <div
                        class="absolute inset-0 flex items-center justify-center bg-black bg-opacity-50 opacity-0 group-hover:opacity-100 transition duration-300">
                        <button
                            onclick="gotoFillData(base64encoded('.{{asset('public/assets/temp-imgs/two-column/tclm (3).jpg')}}.'));"
                            class="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition">Use
                            Template</button>
                    </div>
                </div>
                ...
                <div class="template-item relative group border rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition duration-300"
                    ...
                    <div
                        class="absolute inset-0 flex items-center justify-center bg-black bg-opacity-50 opacity-0 group-hover:opacity-100 transition duration-300">
                        <button
                            onclick="gotoFillData(base64encoded('.{{asset('public/assets/temp-imgs/two-column/tclm (6).png')}}.'));"
                            class="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition">Use
                            Template</button>
                    </div>
                </div>
                ...
                <div class="template-item relative group border rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition duration-300"
                    ...
                    <div
                        class="absolute inset-0 flex items-center justify-center bg-black bg-opacity-50 opacity-0 group-hover:opacity-100 transition duration-300">
                        <button
                            onclick="gotoFillData(base64encoded('.{{asset('public/assets/temp-imgs/two-column/tclm (9).png')}}.'));"
                            class="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition">Use
                            Template</button>
                    </div>
                </div>
                ...
                <div class="template-item relative group border rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition duration-300"
                    ...
                    <div
                        class="absolute inset-0 flex items-center justify-center bg-black bg-opacity-50 opacity-0 group-hover:opacity-100 transition duration-300">
                        <button
                            onclick="gotoFillData(base64encoded('.{{asset('public/assets/temp-imgs/google-docs/gd (6).png')}}.'));"
                            class="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition">Use
                            Template</button>
                    </div>
                </div>
                ...
                <div class="template-item relative group border rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition duration-300"
                    ...
                    <div
                        class="absolute inset-0 flex items-center justify-center bg-black bg-opacity-50 opacity-0 group-hover:opacity-100 transition duration-300">
                        <button
                            onclick="gotoFillData(base64encoded('.{{asset('public/assets/temp-imgs/google-docs/gd (7).png')}}.'));"
                            class="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition">Use
                            Template</button>
                    </div>
                </div>
                ...
                <div class="template-item relative group border rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition duration-300"
                    ...
                    <div
                        class="absolute inset-0 flex items-center justify-center bg-black bg-opacity-50 opacity-0 group-hover:opacity-100 transition duration-300">
                        <button
                            onclick="gotoFillData(base64encoded('.{{asset('public/assets/temp-imgs/google-docs/gd (8).png')}}.'));"
                            class="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition">Use
                            Template</button>
                    </div>
                </div>
                <div class="template-item relative group border rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition duration-300"
                    ...
                    <div
                        class="absolute inset-0 flex items-center justify-center bg-black bg-opacity-50 opacity-0 group-hover:opacity-100 transition duration-300">
                        <button
                            onclick="gotoFillData(base64encoded('.{{asset('public/assets/temp-imgs/two-column/tclm (16).png')}}.'));"
                            class="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition">Use
                            Template</button>
                    </div>
                </div>
                ...
                <div class="template-item relative group border rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition duration-300"
                    ...
                    <div
                        class="absolute inset-0 flex items-center justify-center bg-black bg-opacity-50 opacity-0 group-hover:opacity-100 transition duration-300">
                        <button
                            onclick="gotoFillData(base64encoded('.{{asset('public/assets/temp-imgs/google-docs/gd (9).png')}}.'));"
                            class="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition">Use
                            Template</button>
                    </div>
                </div>
                ...
                <div class="template-item relative group border rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition duration-300"
                    ...
                    <div
                        class="absolute inset-0 flex items-center justify-center bg-black bg-opacity-50 opacity-0 group-hover:opacity-100 transition duration-300">
                        <button
                            onclick="gotoFillData(base64encoded('.{{asset('public/assets/temp-imgs/google-docs/gd (10).png')}}.'));"
                            class="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition">Use
                            Template</button>
                    </div>
                </div>
                ...
                <div class="template-item relative group border rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition duration-300"
                    ...
                    <div
                        class="absolute inset-0 flex items-center justify-center bg-black bg-opacity-50 opacity-0 group-hover:opacity-100 transition duration-300">
                        <button
                            onclick="gotoFillData(base64encoded('.{{asset('public/assets/temp-imgs/two-column/tclm (21).png')}}.'));"
                            class="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition">Use
                            Template</button>
                    </div>
                </div>
                <div class="template-item relative group border rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition duration-300"
                    ...
                    <div
                        class="absolute inset-0 flex items-center justify-center bg-black bg-opacity-50 opacity-0 group-hover:opacity-100 transition duration-300">
                        <button
                            onclick="gotoFillData(base64encoded('.{{asset('public/assets/temp-imgs/google-docs/gd (12).png')}}.'));"
                            class="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition">Use
                            Template</button>
                    </div>
                </div>
                ...
                <div class="template-item relative group border rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition duration-300"
                    ...
                    <div
                        class="absolute inset-0 flex items-center justify-center bg-black bg-opacity-50 opacity-0 group-hover:opacity-100 transition duration-300">
                        <button
                            onclick="gotoFillData(base64encoded('.{{asset('public/assets/temp-imgs/simple/smpl (4).png')}}.'));"
                            class="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition">Use
                            Template</button>
                    </div>
                </div>
                <div class="template-item relative group border rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition duration-300"
                    ...
                    <div
                        class="absolute inset-0 flex items-center justify-center bg-black bg-opacity-50 opacity-0 group-hover:opacity-100 transition duration-300">
                        <button
                            onclick="gotoFillData(base64encoded('.{{asset('public/assets/temp-imgs/google-docs/gd (18).png')}}.'));"
                            class="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition">Use
                            Template</button>
                    </div>
                </div>
                ...
                <div class="template-item relative group border rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition duration-300"
                    ...
                    <div
                        class="absolute inset-0 flex items-center justify-center bg-black bg-opacity-50 opacity-0 group-hover:opacity-100 transition duration-300">
                        <button
                            onclick="gotoFillData(base64encoded('.{{asset('public/assets/temp-imgs/simple/smpl (7).png')}}.'));"
                            class="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition">Use
                            Template</button>
                    </div>
                </div>
                ...
                <div class="template-item relative group border rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition duration-300"
                    ...
                    <div
                        class="absolute inset-0 flex items-center justify-center bg-black bg-opacity-50 opacity-0 group-hover:opacity-100 transition duration-300">
                        <button
                            onclick="gotoFillData(base64encoded('.{{asset('public/assets/temp-imgs/simple/smpl (9).png')}}.'));"
                            class="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition">Use
                            Template</button>
                    </div>
                </div>
