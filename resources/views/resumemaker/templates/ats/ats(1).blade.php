...
<body>
  ...
  <div class="section">
    ...
    <p>
      Big Data Engineer with twelve years of experience designing and executing solutions for complex business problems.
  ...
  <div class="section">
    ...
    <div class="job">
      ...
      <ul>
        <li>Attained 25% growth in revenue and customers by analyzing business needs and designing a new data warehouse.</li>
        <li>Led 10 data initiatives that reduced operating costs by 20% and created customized programming options.</li>
    ...
    <div class="job">
      ...
      <ul>
        <li>Built FIT system that saved $40,000 annually in vendor costs for a web app with 5,000 daily users.</li>
  ...
  <div class="section skills">
    ...
    <p><strong>Skills:</strong> Modeling and Design, Data Analytics, Big Data Processing, AWS, Statistical Modeling, Hive, Hadoop, ETL, Java</p>
