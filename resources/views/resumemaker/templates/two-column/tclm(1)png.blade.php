    ...
    <div class="container">
        <div class="left">
            ...
            <div class="section">
                ...
                <div class="contact">
                    <div class="icon-line">
                        <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="#000" viewBox="0 0 24 24"
                            style="vertical-align: middle; margin-right: 8px;">
                            <path
                                d="M22 16.92v3a2 2 0 0 1-2.18 2A19.79 19.79 0 0 1 3.09 4.18 2 2 0 0 1 5 2h3a2 2 0 0 1 2 1.72 13 13 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L9 10a16 16 0 0 0 6 6l1.36-1.36a2 2 0 0 1 2.11-.45 13 13 0 0 0 2.81.7A2 2 0 0 1 22 16.92z" />
                        </svg>
                        (123) 456-7890
                    </div>
                    <div class="icon-line">
                        <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="#000" viewBox="0 0 24 24"
                            style="vertical-align: middle; margin-right: 8px;">
                            <path
                                d="M20 4H4a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V6a2 2 0 0 0-2-2zM4 8l8 5 8-5m0-2l-8 5-8-5" />
                        </svg>
                    ...
                    <div class="icon-line">
                        <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="#000" viewBox="0 0 24 24"
                            style="vertical-align: middle; margin-right: 8px;">
                            <path d="M16 8a6 6 0 0 1-6 6H7l-4 4V6a2 2 0 0 1 2-2h9a6 6 0 0 1 6 6z" />
                        </svg>
                        @Jackwilliam
                    </div>
                </div>
