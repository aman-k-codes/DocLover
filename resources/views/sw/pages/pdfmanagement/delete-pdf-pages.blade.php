...
<section class="py-10 px-4">
    ...
    <div id="splitSection" class="mt-8 max-w-3xl mx-auto text-center">
        <button id="splitBtn" class="bg-gray-800 text-white font-semibold px-8 py-3 rounded-lg shadow-md hover:bg-red-700 hidden">
...
<section class="bg-white py-16">
    <div class="max-w-4xl mx-auto px-6 text-center">
        ...
        <p class="text-lg text-gray-600 mb-8">Easily remove unwanted pages from your PDF document in three simple steps.</p>
