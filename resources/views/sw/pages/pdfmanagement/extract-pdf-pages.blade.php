...
<section class="py-10 px-4">
    ...
    <div id="extractSection" class="mt-8 max-w-3xl mx-auto text-center">
        <button id="extractBtn" class="bg-gray-800 text-white font-semibold px-8 py-3 rounded-lg shadow-md hover:bg-green-700 hidden">
    ...
    <div id="downloadSection" class="hidden mt-8 max-w-3xl mx-auto text-center bg-white shadow-lg rounded-2xl p-6 border border-gray-200">
        <div class="flex flex-col items-center">
            ...
            <a id="downloadExtractBtn" href="#" class="mt-6 bg-green-700 hover:bg-green-800 text-white font-semibold px-6 py-3 rounded-lg shadow-md">
                <i class="fas fa-download mr-2"></i>
                Download Extracted PDF
            </a>

            <div class="flex flex-wrap justify-center mt-6 space-x-4">
                <button id="extractAgainBtn" onclick="extractAgain()" class="bg-gray-700 text-white font-semibold px-6 py-3 rounded-lg hover:bg-gray-800 shadow-md transition duration-200">
...
<section class="bg-white py-16">
    <div class="max-w-4xl mx-auto px-6 text-center">
        ...
        <p class="text-lg text-gray-600 mb-8">Easily extract specific pages from your PDF document in three simple steps.</p>
