...
@section('meta_description', 'Convert PDF files to Excel (XLSX) format quickly and securely with CraftMyDoc.')
@section('meta_keywords', 'PDF to Excel, PDF Converter, File Conversion, XLSX Converter')

@section('content')
    <!-- Hero Section -->
    <section class="pt-12 px-4 bg-gray-50">
        <div class="max-w-3xl mx-auto text-center">
            <h2 class="text-4xl font-extrabold text-gray-800">Convert PDF to Excel Instantly</h2>
            <p class="text-lg text-gray-600 mt-3">Upload your PDF file and get an Excel file in seconds with our fast and secure converter.</p>
        </div>
    </section>
    ...
    <section class="py-18 bg-gray-50">
        <div class="max-w-6xl mx-auto px-6">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-10 text-center">
                @foreach([
                    ['📊', 'Accurate Excel Output', 'Your tables and data are cleanly extracted into XLSX format.'],
    ...
    <section class="bg-white py-16">
        <div class="max-w-4xl mx-auto px-6 text-center">
            <h2 class="text-3xl font-extrabold text-gray-900 mb-4">How to Convert PDF to Excel</h2>
            <p class="text-lg text-gray-600 mb-8">Follow these simple steps to transform your PDF into an Excel spreadsheet.</p>

            <div class="text-left max-w-2xl mx-auto">
                <ol class="space-y-6 list-none">
                    @foreach([
                        ['Upload your PDF file', 'Drag & drop or select the PDF file you want to convert.'],
                        ['Start conversion', 'Click the convert button to begin processing.'],
                        ['Download Excel file', 'Save the Excel file with your extracted tables or data.']
                    ] as $index => $step)
