...
@section('content')
    ...
    <section class="pt-12 px-4 bg-gray-50">
        <div class="max-w-3xl mx-auto text-center">
            <h2 class="text-4xl font-extrabold text-gray-800">Convert PDF to PowerPoint Instantly</h2>
            <p class="text-lg text-gray-600 mt-3">Upload your PDF and get a fully editable PowerPoint file in seconds with our secure converter.</p>
        </div>
    </section>
    ...
    <section class="py-10 px-4">
        <div class="flex flex-col sm:flex-row sm:justify-center sm:space-x-8 space-y-4 sm:space-y-0 bg-indigo-50 rounded-2xl p-6 max-w-2xl mx-auto mb-8 shadow">
            ...
            <div class="flex items-center space-x-2">
                ...
                <span class="text-gray-800 font-semibold">Convert to PPT</span>
            </div>
            <div class="flex items-center space-x-2">
                <div class="w-8 h-8 flex items-center justify-center bg-indigo-700 text-white rounded-full font-bold">3</div>
                <span class="text-gray-800 font-semibold">Download PPT File</span>
            </div>
        </div>
        ...
        <div class="border-2 border-dashed border-gray-300 rounded-2xl p-10 max-w-3xl mx-auto text-center bg-white shadow-md">
            ...
            <p class="text-sm text-gray-500 mt-4">Max file size: 10MB. Only PDF files supported.</p>
        </div>
    </section>
    ...
    <section class="py-18 bg-gray-50">
        <div class="max-w-6xl mx-auto px-6">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-10 text-center">
                @foreach([
                    ['📽️', 'Editable PowerPoint Slides', 'Easily edit the converted PPTX in Microsoft PowerPoint or Google Slides.'],
    ...
    <section class="bg-white py-16">
        <div class="max-w-4xl mx-auto px-6 text-center">
            <h2 class="text-3xl font-extrabold text-gray-900 mb-4">How to Convert PDF to PPT</h2>
            <p class="text-lg text-gray-600 mb-8">Just follow these quick steps to transform your PDF into a presentation-ready PowerPoint file.</p>

            <div class="text-left max-w-2xl mx-auto">
                <ol class="space-y-6 list-none">
                    @foreach([
                        ['Upload your PDF file', 'Drag & drop or select the PDF you want to convert to PowerPoint.'],
                        ['Start conversion', 'Click the convert button to start generating your presentation.'],
                        ['Download PPTX file', 'Save the editable PPTX file to your device.']
                    ] as $index => $step)
