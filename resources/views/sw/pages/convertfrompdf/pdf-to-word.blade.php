...
@section('meta_description', 'Convert PDF files to editable Word (DOCX) format quickly and securely with DocLover.')
@section('meta_keywords', 'PDF to Word, PDF to DOCX, File Conversion, Word Converter')
...
@section('content')
    ...
    <section class="pt-12 px-4 bg-gray-50">
        <div class="max-w-3xl mx-auto text-center">
            ...
            <p class="text-lg text-gray-600 mt-3">Upload your PDF and get a fully editable Word document in seconds with our secure converter.</p>
        </div>
    </section>
    ...
    <section class="py-18 bg-gray-50">
        <div class="max-w-6xl mx-auto px-6">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-10 text-center">
                @foreach([
                    ['📝', 'Editable Word Documents', 'Easily edit the converted DOCX in Microsoft Word or Google Docs.'],
    ...
    <section class="bg-white py-16">
        <div class="max-w-4xl mx-auto px-6 text-center">
            <h2 class="text-3xl font-extrabold text-gray-900 mb-4">How to Convert PDF to Word</h2>
            <p class="text-lg text-gray-600 mb-8">Just follow these quick steps to transform your PDF into a fully editable Word document.</p>

            <div class="text-left max-w-2xl mx-auto">
                <ol class="space-y-6 list-none">
                    @foreach([
                        ['Upload your PDF file', 'Drag & drop or select the PDF you want to convert to Word.'],
                        ['Start conversion', 'Click the convert button to begin transforming your document.'],
                        ['Download DOCX file', 'Save the editable Word file to your device.']
                    ] as $index => $step)
