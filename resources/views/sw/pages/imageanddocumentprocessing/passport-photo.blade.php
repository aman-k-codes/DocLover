...
<section class="pt-12 px-4 bg-gray-50">
    <div class="max-w-3xl mx-auto text-center">
        ...
        <p class="text-lg text-gray-600 mt-3">Upload photo, remove background, choose standard sizes and get printable sheet!</p>
    </div>
</section>
...
<section class="py-10 px-4">
    ...
    <div id="imagePreviewContainer" class="hidden mt-8 max-w-3xl mx-auto text-center bg-white shadow-lg rounded-2xl p-6">
        ...
        <div class="mt-4">
            ...
            <input type="color" id="bgColorPicker" value="#ffffff" onchange="changeBackgroundColor()" class="border-2 rounded px-2 py-1">
        </div>
        ...
        <!-- Create Sheet Button -->
        <div class="mt-8">
            <button id="createSheetBtn" onclick="createSheet()" class="bg-green-600 text-white font-semibold px-8 py-3 rounded-lg hover:bg-green-700 shadow-md transition-all hidden">
    ...
    <div id="downloadSection" class="hidden mt-10 max-w-3xl mx-auto text-center bg-white shadow-lg rounded-2xl p-6 border border-gray-200">
        ...
        <a id="downloadLink" class="bg-blue-600 text-white font-semibold px-6 py-3 rounded-lg hover:bg-blue-700 shadow-md transition duration-200" download="passport_photos_sheet.png">
...
<style>
    ...
    .size-button.active, .sheet-button.active {
        background-color: #4f46e5;
        color: white;
        border-color: #4f46e5;
    }
    .size-button:hover, .sheet-button:hover {
    ...
    function createSheet() {
        ...
        for (let y = 0; y < rows; y++) {
            for (let x = 0; x < columns; x++) {
                sheetCtx.drawImage(canvas, 0, 0, canvas.width, canvas.height, x * photoWidth, y * photoHeight, photoWidth, photoHeight);
            }
        }
