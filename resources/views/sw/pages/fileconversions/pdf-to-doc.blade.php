...
@section('meta_description', 'Convert any PDF to a Word (.docx) file easily with DocLover.')
...
<section class="py-18 bg-gray-50">
    <div class="max-w-6xl mx-auto px-6">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-10 text-center">
            @foreach([
                ['⚡', 'Quick Conversion', 'Upload your PDF and get a DOC file instantly.'],
                ['🔐', 'Secure & Private', 'Files are encrypted and never stored.'],
                ['📱', 'Any Device, Anywhere', 'Works seamlessly on desktop, tablet, and mobile.']
            ] as $feature)
...
<section class="bg-white py-16">
    <div class="max-w-4xl mx-auto px-6 text-center">
        ...
        <p class="text-lg text-gray-600 mb-8">Just follow these simple steps to convert your PDF into an editable Word document.</p>
        <div class="text-left max-w-2xl mx-auto">
            <ol class="space-y-6 list-none">
                @foreach([
                    ['Upload your PDF file', 'Drag & drop or click to browse and upload.'],
                    ['Start conversion', 'Click the convert button to convert your PDF to DOC.'],
                    ['Download the DOC file', 'Your editable Word document will be ready to download.']
                ] as $index => $step)
