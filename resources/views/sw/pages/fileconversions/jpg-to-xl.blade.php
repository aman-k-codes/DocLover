...
@section('content')
    <section class="pt-12 px-4 bg-gray-50">
        <div class="max-w-3xl mx-auto text-center">
            ...
            <p class="text-lg text-gray-600 mt-3">Upload your image and download a .xlsx file with extracted tabular data.
            </p>
        </div>
    </section>
    ...
    <section class="py-10 px-4">
        ...
        <div id="loaderSection" class="hidden fixed inset-0 bg-white bg-opacity-75 flex items-center justify-center z-50">
            <div class="text-center">
                ...
                <p class="text-gray-700 font-semibold text-lg">Converting JPGE to Excel, please wait...</p>
            </div>
        </div>
    </section>
    ...
    <section class="bg-white py-16">
        <div class="max-w-4xl mx-auto px-6 text-center">
            ...
            <p class="text-lg text-gray-600 mb-8">Just follow these simple steps to extract table data from an image into
                Excel (.xlsx).</p>
