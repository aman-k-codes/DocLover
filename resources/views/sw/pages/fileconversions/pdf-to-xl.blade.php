...
@section('content')
    ...
    <section class="pt-12 px-4 bg-gray-50">
        <div class="max-w-3xl mx-auto text-center">
            ...
            <p class="text-lg text-gray-600 mt-3">Upload your PDF file and get a fully formatted Excel spreadsheet in seconds with our fast and secure converter.</p>
        </div>
    </section>
    ...
    <section class="py-18 bg-gray-50">
        <div class="max-w-6xl mx-auto px-6">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-10 text-center">
                @foreach([
                    ['📊', 'Accurate Excel Output', 'Generate structured spreadsheets ready for analysis.'],
    ...
    <section class="bg-white py-16">
        <div class="max-w-4xl mx-auto px-6 text-center">
            ...
            <p class="text-lg text-gray-600 mb-8">Follow these simple steps to get an Excel version of your PDF.</p>

            <div class="text-left max-w-2xl mx-auto">
                <ol class="space-y-6 list-none">
                    @foreach([
                        ['Upload your PDF file', 'Drag & drop or browse your device to upload.'],
                        ['Start conversion', 'Click the convert button to generate the Excel file.'],
                        ['Download Excel file', 'Save the .xlsx file to your device instantly.']
                    ] as $index => $step)
