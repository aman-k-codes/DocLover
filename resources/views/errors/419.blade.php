...
<head>
    ...
    <title>419 Page Expired - CraftMyDoc</title>
    ...
    <div class="container mx-auto px-4 py-8">
        <div class="bg-white rounded-lg shadow-xl p-8 md:p-12 max-w-lg mx-auto text-center">
            ...
            <p class="text-gray-600 mb-8 text-base md:text-lg">
                Sorry, your session seems to have expired, possibly due to inactivity or a security token mismatch. This is a security measure to protect your account.
