...
@section('title', 'DocLover - PDF to DOC')

@section('meta_description', 'Convert PDF to DOC easily with DocLover.')
@section('meta_keywords', 'PDF to DOC, Document Conversion, File Conversion')

@section('content')
    <!-- Hero Section -->
    <section class="pt-12 px-4 bg-gray-50">
        <div class="max-w-3xl mx-auto text-center">
            <h2 class="text-4xl font-extrabold text-gray-800">Convert PDF to DOC Instantly</h2>
            <p class="text-lg text-gray-600 mt-3">Upload your PDF file and get a DOC document in seconds with our fast and secure converter.</p>
        </div>
    </section>
    ...
    <section class="py-18 bg-gray-50">
        <div class="max-w-6xl mx-auto px-6">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-10 text-center">
                @foreach([
                    ['🚀', 'Fast & Simple', 'Upload your PDF and get a DOC file instantly.'],
    ...
    <section class="bg-white py-16">
        <div class="max-w-4xl mx-auto px-6 text-center">
            ...
            <p class="text-lg text-gray-600 mb-8">Follow these easy steps to convert your PDF into a Word document.</p>

            <div class="text-left max-w-2xl mx-auto">
                <ol class="space-y-6 list-none">
                    @foreach([
                        ['Upload your PDF file', 'Drag & drop or browse your device to upload.'],
                        ['Start conversion', 'Click the convert button to turn your PDF into a DOC.'],
                        ['Download the DOC', 'Get your Word document instantly.']
                    ] as $index => $step)
