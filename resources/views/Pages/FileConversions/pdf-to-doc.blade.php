...
@section('content')
    ...
    <section class="bg-white py-16">
        <div class="max-w-4xl mx-auto px-6 text-center">
            ...
            <p class="text-lg text-gray-600 mb-8">Follow these steps to turn your PDF into a Word (.docx) file.</p>

            <div class="text-left max-w-2xl mx-auto">
                <ol class="space-y-6 list-none">
                    @foreach ([['Upload your PDF file', 'Select a PDF file to begin.'], ['Start Conversion', 'Click the convert button to convert the content to Word format.'], ['Download Word File', 'Save your converted .docx file.']] as $index => $step)
