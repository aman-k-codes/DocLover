...
@section('content')
    ...
    <section class="pt-12 px-4 bg-gray-50">
        <div class="max-w-3xl mx-auto text-center">
            ...
            <p class="text-lg text-gray-600 mt-3">Upload your JPG image and get a high-quality PNG file in seconds with our fast and secure converter.</p>
        </div>
    </section>
    ...
    <section class="py-18 bg-gray-50">
        <div class="max-w-6xl mx-auto px-6">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-10 text-center">
                @foreach([
                    ['🖼️', 'High Quality PNG Output', 'Preserve image quality during conversion.'],
        ...
        <div class="max-w-4xl mx-auto px-6 text-center">
            ...
            <div class="text-left max-w-2xl mx-auto">
                <ol class="space-y-6 list-none">
                    @foreach([
                        ['Upload your JPG file', 'Drag & drop or browse to select your image.'],
                        ['Start conversion', 'Click the convert button to process the image.'],
                        ['Download PNG file', 'Download the PNG version of your image.']
                    ] as $index => $step)
