...
@section('content')
    ...
    <section class="pt-12 px-4 bg-gray-50">
        <div class="max-w-3xl mx-auto text-center">
            ...
            <p class="text-lg text-gray-600 mt-3">Upload your PNG image and get a high-quality JPG file in seconds with our fast and secure converter.</p>
        </div>
    </section>
    ...
    <section class="py-10 px-4">
        ...
        <div class="border-2 border-dashed border-gray-300 rounded-2xl p-10 max-w-3xl mx-auto text-center bg-white shadow-md">
            ...
            <label class="inline-flex items-center bg-indigo-700 text-white font-semibold px-6 py-3 rounded-md cursor-pointer hover:bg-indigo-800">
                ...
                Upload PNG
                <input type="file" class="hidden" accept=".png" />
            </label>
            <p class="text-sm text-gray-500 mt-4">Max file size: 10MB. Only PNG files supported.</p>
        </div>
    </section>
    ...
    <section class="py-18 bg-gray-50">
        <div class="max-w-6xl mx-auto px-6">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-10 text-center">
                @foreach([
                    ['🖼️', 'High Quality JPG Output', 'Preserve image quality during conversion.'],
                    ['🔒', 'Privacy Guaranteed', 'Your images are encrypted and never stored.'],
                    ['📱', 'Platform Independent', 'Works on desktop, tablet, or mobile.']
                ] as $feature)
        ...
        <div class="max-w-4xl mx-auto px-6 text-center">
            ...
            <div class="text-left max-w-2xl mx-auto">
                <ol class="space-y-6 list-none">
                    @foreach([
                        ['Upload your PNG file', 'Drag & drop or browse to select your image.'],
                        ['Start conversion', 'Click the convert button to process the image.'],
                        ['Download JPG file', 'Download the JPG version of your image.']
                    ] as $index => $step)
