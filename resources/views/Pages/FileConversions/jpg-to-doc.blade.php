...
@section('title', 'DocLover - JPG to DOC')

@section('meta_description', 'Convert JPG images to DOC files quickly and securely with DocLover.')
@section('meta_keywords', 'JPG to DOC, Image to Document, File Conversion, DOC Converter')

@section('content')
    <!-- Hero Section -->
    <section class="pt-12 px-4 bg-gray-50">
        <div class="max-w-3xl mx-auto text-center">
            <h2 class="text-4xl font-extrabold text-gray-800">Convert JPG to DOC Instantly</h2>
            <p class="text-lg text-gray-600 mt-3">Upload your JPG image and get a DOC file in seconds with our fast and secure converter.</p>
        </div>
    </section>
    ...
    <section class="py-10 px-4">
        <div class="flex flex-col sm:flex-row sm:justify-center sm:space-x-8 space-y-4 sm:space-y-0 bg-indigo-50 rounded-2xl p-6 max-w-2xl mx-auto mb-8 shadow">
            ...
            <div class="flex items-center space-x-2">
                ...
                <span class="text-gray-800 font-semibold">Convert to DOC</span>
            </div>
            <div class="flex items-center space-x-2">
                <div class="w-8 h-8 flex items-center justify-center bg-indigo-700 text-white rounded-full font-bold">3</div>
                <span class="text-gray-800 font-semibold">Download DOC File</span>
            </div>
        </div>
    ...
    <section class="py-18 bg-gray-50">
        <div class="max-w-6xl mx-auto px-6">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-10 text-center">
                @foreach([
                    ['📄', 'Accurate DOC Output', 'Your image content is clearly converted into editable DOC format.'],
    ...
    <section class="bg-white py-16">
        <div class="max-w-4xl mx-auto px-6 text-center">
            <h2 class="text-3xl font-extrabold text-gray-900 mb-4">How to Convert JPG to DOC</h2>
            <p class="text-lg text-gray-600 mb-8">Follow these simple steps to transform your JPG image into a DOC file.</p>
            ...
            <div class="text-left max-w-2xl mx-auto">
                <ol class="space-y-6 list-none">
                    @foreach([
                        ...
                        ['Download DOC file', 'Save the DOC file with your extracted text or content.']
                    ] as $index => $step)
