...
@section('meta_description', 'Convert PDF to JPG easily with DocLover.')
@section('meta_keywords', 'PDF to JPG, Image Conversion, File Conversion')
...
@section('content')
    ...
    <section class="pt-12 px-4 bg-gray-50">
        <div class="max-w-3xl mx-auto text-center">
            ...
            <p class="text-lg text-gray-600 mt-3">Upload your PDF file and get high-quality JPG images in seconds with our fast and secure converter.</p>
        </div>
    </section>
    ...
    <section class="py-10 px-4">
        <div class="flex flex-col sm:flex-row sm:justify-center sm:space-x-8 space-y-4 sm:space-y-0 bg-indigo-50 rounded-2xl p-6 max-w-2xl mx-auto mb-8 shadow">
            ...
            <div class="flex items-center space-x-2">
                ...
                <span class="text-gray-800 font-semibold">Download JPG Files</span>
            </div>
        </div>
    ...
    <section class="py-18 bg-gray-50">
        <div class="max-w-6xl mx-auto px-6">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-10 text-center">
                @foreach([
                    ['📸', 'High-Quality Images', 'Get crisp JPG files extracted from your PDF.'],
                    ['🔒', 'Privacy Guaranteed', 'Your files are encrypted and never stored.'],
                    ['📱', 'Works Everywhere', 'Use on desktop, tablet, or mobile without hassle.']
                ] as $feature)
    ...
    <section class="bg-white py-16">
        <div class="max-w-4xl mx-auto px-6 text-center">
            ...
            <p class="text-lg text-gray-600 mb-8">Follow these simple steps to extract images from your PDF file.</p>

            <div class="text-left max-w-2xl mx-auto">
                <ol class="space-y-6 list-none">
                    @foreach([
                        ['Upload your PDF file', 'Drag & drop or browse your device to upload.'],
                        ['Start conversion', 'Click the convert button to generate JPG images.'],
                        ['Download JPG files', 'Save your high-quality image files instantly.']
                    ] as $index => $step)
